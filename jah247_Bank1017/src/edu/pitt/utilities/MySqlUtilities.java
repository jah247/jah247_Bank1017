...
public class MySqlUtilities implements DbUtilities {
	...
	private String hostName = "sis-teach-01.sis.pitt.edu:3306"; // server
	// address +
	// port number
	private String dbName = "jah247_bank1017"; // default database name
	private String dbUserName = "jah247"; // login name for the database server
	private String dbPassword = "3952866"; // password for the database server
